...
const pointsStyle = feature => new Style({
    image: new CircleStyle({
        radius: 10,
        fill: new Fill({ color: "rgb(102, 51, 0)" }),
        stroke: new Stroke({ color: "rgb(255, 204, 153)", width: 2.5 }),
    }),
...
const singleMapClick = new Select({
    ...
    style: new Style({
        image: new CircleStyle({
            radius: 12,
            fill: new Fill({ color: "rgb(255, 204, 153)" }),
            stroke: new Stroke({ color: "rgb(102, 51, 0)", width: 2 }),
        }),
    })
