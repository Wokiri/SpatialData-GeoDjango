module.exports = {
  entry: {
    ...
    // controls_shp_preview_map: './src/js/controls_shp_preview_map.js',
    // existing_controls_map: './src/js/existing_controls_map.js',
    // existing_parcels_map: './src/js/existing_parcels_map.js',
    parcel_detail_map: './src/js/parcel_detail_map.js',
